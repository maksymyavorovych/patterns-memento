...
const usersCaretaker = new Caretaker(new Memento([...UsersMock], 'Initial'), $usersList);
const usersControlsComponent = new UsersControlsComponent('controls', $usersList, usersCaretaker);
const usersComponent = new UsersListComponent('main', $usersList, usersCaretaker);
const usersPreviewComponent = new UsersPreviewComponent('preview', $usersList, usersCaretaker);
